  ...
  <table class="cmstable">
    <thead>
      <tr> 
        ...
        <th>
          <div><span>nama destinasi</span>
          <?php 
          if($sord=="desc"){
          ?>
            <a href="index.php?act=browse&p_id=<?php echo $p_id; ?>&sidx=c.nama&sord=asc" title="asc">
            <span class="ion-arrow-down-b"></span>
            </a>
          <?php 
          }else{
          ?>
            <a href="index.php?act=browse&p_id=<?php echo $p_id; ?>&sidx=c.nama&sord=desc" title="desc">
