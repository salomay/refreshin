...
<?php if($_SESSION['msg']!=""){ ?>
  ...
  //print_r($app[me]);
  ?>
  <h2>Merubah <span class="label label-primary"> Biaya Destinasi</span> <?php echo $dbu->lookup("nama",$app[table][komunitas],"id ='".$p_id."'"); ?></h2>
  <br/> 
<form method="post" enctype="multipart/form-data">
<div>
	<div>
	<div>destinasi yang akan di rubah</div>
	<div>
		&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $dbu->lookup("nama","destinasi_bahasa","id_reff ='".$dbu->lookup("id_reff","destinasi","id='".$dbu->lookup("id_destinasi",$app[table][komunitas_destinasi],"id='".$sub."'")."'")."'"); ?>
	</select>
	</div>
</div>
<div>
