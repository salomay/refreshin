...
<?php if($_SESSION['msg']!=""){ ?>
  ...
  $_SESSION['alt']="";
  ?>
  <h2>Daftar <span class="label label-primary">Negara</span></h2>
  <br/> 
    ...
    <thead>
      <tr> 
        ...
        <th>
          ...
          if($sord=="desc"){
          ?>
            <a href="index.php?act=browse&sidx=pos_lat&sord=asc" title="asc">
            <span class="ion-arrow-down-b"></span>
            </a>
          <?php 
          }else{
          ?>
            <a href="index.php?act=browse&sidx=pos_lat&sord=desc" title="desc">
            <span class="ion-arrow-up-b"></span>
            </a>
          <?php
          }
        ...
        <th>
          ...
          if($sord=="desc"){
          ?>
            <a href="index.php?act=browse&sidx=pos_long&sord=asc" title="asc">
            <span class="ion-arrow-down-b"></span>
            </a>
          <?php 
          }else{
          ?>
            <a href="index.php?act=browse&sidx=pos_long&sord=desc" title="desc">
            <span class="ion-arrow-up-b"></span>
            </a>
          <?php
          }
      ...
      ?>
        <tr <?php echo($nors % 2 == 1)?'class="odd"':'class="even"'; ?>>
          ...
          <td style="text-align:center">
            <?php 
            if ($rshasil['bendera']){ 
              $filename = $app['data_path']."/bendera/".$rshasil['bendera'];           
            if(file_exists($filename)){
            ?>
              <img src="<?php echo  $app['data_www'];?>/bendera/<?php echo $rshasil['bendera'];?>" width="50" height="30" />
          <?php }else{ ?>
