...
<?php if($_SESSION['msg']!=""){ ?>
  ...
  //print_r($app[me]);
  ?>
  <h2>Membuat <span class="label label-primary"> Komunitas</span></h2>
  <br/> 
...
<div>
	...
	<div>
	<input type="text" name="p_nama" id="p_nama" placeholder="x3m gank" size="50" />
	</div>
</div>
<br/>
<div>
	<div>lokasi *</div>
	<div>
	<input type="text" name="p_lokasi" id="p_lokasi" placeholder="X Spot ...." size="100" />
	</div>
</div>
<br/>
<div>
...
<div>
	...
	<div>
		<input name="p_start" type="text" id="p_start" value="<?php echo date("d/m/Y") ?>" />
        (31/12/1981)
	</div>
</div>
<br/>
