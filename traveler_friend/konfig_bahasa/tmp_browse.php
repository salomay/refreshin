...
<?php if($_SESSION['msg']!=""){ ?>
  ...
  //print_r($rshasil);
  ?>
  <h2>Daftar <span class="label label-primary">Konfigurasi Detail</span></h2>
  <br/> 
...
<form method="post">
  <div class="table_filter">
    <select class="form-control" name="fcari" >
      <option value="a.headline">headline</option>
      <option value="b.bahasa">bahasa</option>
      <option value="a.slogan">slogan</option>
      <option value="a.meta_description">meta deskripsi</option>
    </select>
  ...
  <table class="cmstable">
    <thead>
      <tr> 
        ...
        <th>
          <div><span>headline</span>
          <?php 
          if($sord=="desc"){
          ?>
            <a href="index.php?act=browse&sidx=a.headline&sord=asc" title="asc">
            <span class="ion-arrow-down-b"></span>
            </a>
          <?php 
          }else{
          ?>
            <a href="index.php?act=browse&sidx=a.headline&sord=desc" title="desc">
            <span class="ion-arrow-up-b"></span>
            </a>
          <?php
          }
        ...
        <th>
          <div><span>slogan</span>
          <?php 
          if($sord=="desc"){
          ?>
            <a href="index.php?act=browse&sidx=a.slogan&sord=asc" title="asc">
            <span class="ion-arrow-down-b"></span>
            </a>
          <?php 
          }else{
          ?>
            <a href="index.php?act=browse&sidx=a.slogan&sord=desc" title="desc">
            <span class="ion-arrow-up-b"></span>
            </a>
          <?php
          }
    ...
    <tbody>
      ...
      ?>
        <tr <?php echo($nors % 2 == 1)?'class="odd"':'class="even"'; ?>>
          ...
          <td>
            <?php echo $rshasil["headline"]; ?>&nbsp;&nbsp;<a href="index.php?act=view&p_id=<?php echo $rshasil[id]; ?>" title="view detail" >
              <span class="ion-toggle-filled"></span></a>
          </td>
          <td>
            <?php echo $rshasil["slogan"]; ?>
          </td>
          <td style="text-align:center;">
            <?php 
