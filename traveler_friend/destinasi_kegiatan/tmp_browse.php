...
<?php if($_SESSION['msg']!=""){ ?>
  ...
  //print_r($rshasil);
  ?>
  <h2>Daftar <span class="label label-primary">kegiatan Destinasi</span> <?php echo $dbu->lookup("nama","destinasi_bahasa","id_reff ='".$dbu->lookup("id_reff","destinasi","id='".$p_id."'")."'"); ?></h2>
  <br/> 
