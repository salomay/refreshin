...
<?php if($_SESSION['msg']!=""){ ?>
  ...
  //print_r($app[me]);
  ?>
  <h2>Merubah <span class="label label-primary"> Kegiatan Destinasi</span> <?php echo $dbu->lookup("nama","destinasi_bahasa","id_reff ='".$dbu->lookup("id_reff","destinasi","id='".$p_id."'")."'"); ?></h2>
  <br/> 
...
<div>
	<div>nama *</div>
	<div>
	<input type="text" name="p_nama" id="p_nama" value="<?php echo $form[nama]; ?>" placeholder="..." size="100" />
	</div>
</div>
<br/>
<div>
