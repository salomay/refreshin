...
<?php if($_SESSION['msg']!=""){ ?>
  ...
  //print_r($app[me]);
  ?>
  <h2>Membuat <span class="label label-primary"> Rute Destinasi</span> <?php echo $dbu->lookup("nama","destinasi_bahasa","id_reff ='".$dbu->lookup("id_reff","destinasi","id='".$p_id."'")."'"); ?></h2>
  <br/> 
...
<div>
	<div>harga *</div>
	<div>
	<input type="text" name="p_harga" id="p_harga" placeholder="Rp. 500.000" size="100" />
	</div>
</div>
<br/>
<div>
