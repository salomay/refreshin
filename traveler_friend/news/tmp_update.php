...
<div>
	...
	<div>
		<input name="p_judul" type="text" id="p_judul" size="60" value="<?php echo $form[judul]; ?>"  placeholder = "http://refreshin.co.id ..."/>
	</div>
</div>
<br/>
<div>
	<div>Sinopsis *</div>
	<div>
	<textarea name="p_sinopsis" id="p_sinopsis" ><?php echo $form[sinopsis]; ?></textarea>
	</div>
</div>
<br/>
<div>
	<div>deskripsi *</div>
	<div>
	<textarea name="p_desk" id="p_desk" ><?php echo $form[isi]; ?></textarea>
	</div>
</div>
<br/>
<div>
	<div>thumb Berita *</div>
	<div>
		<?php 
		if ($form['thumb']){ 
				$filename = $app['data_path']."/berita/thumb/".$form['thumb'];
			if (file_exists($filename)) {
			 ?>
			 	<img src="<?php echo  $app['data_www'];?>/berita/thumb/<?php echo $form[thumb];?>" width="50" height="50" /> <br> 
				<input type="checkbox" class="checkbox" name="p_gambar_del" value="1">check to remove <br />
			 <?php
			} else {
			 ?>
			 	<img src="<?php echo  $app['data_www']?>/berita/thumb/default.jpg" width="50" height="50" />
				<br><br>
			 <?php }
			} else { ?>
			<img src="<?php echo  $app['data_www']?>/berita/thumb/default.jpg" width="50" height="50" />
...
<br/>
<div>
	<div>gambar Berita *</div>
	<div>
		<?php 
		if ($form['gambar']){ 
				$filename = $app['data_path']."/berita/gambar/".$form['gambar'];
			if (file_exists($filename)) {
			 ?>
			 	<img src="<?php echo  $app['data_www'];?>/berita/gambar/<?php echo $form[gambar];?>" width="50" height="50" /> <br> 
				<input type="checkbox" class="checkbox" name="p_gambar_del" value="1">check to remove <br />
			 <?php
			} else {
			 ?>
			 	<img src="<?php echo  $app['data_www']?>/berita/gambar/default.png" width="50" height="50" />
				<br><br>
			 <?php }
			} else { ?>
			<img src="<?php echo  $app['data_www']?>/berita/gambar/default.png" width="50" height="50" />
