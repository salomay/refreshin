...
$upload_dir = '/reff/point_of_view/tinymce/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../point_of_view/tinymce/upload/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../point_of_view/tinymce/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
